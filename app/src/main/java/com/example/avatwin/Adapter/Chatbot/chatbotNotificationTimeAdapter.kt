...
class chatbotNotificationTimeAdapter(var item:ArrayList<String>, val context: Context):RecyclerView.Adapter<chatbotNotificationTimeAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView){
        ...
        fun setItem(item: String){
            itemView.chatbot_item_txt.text = item
